    ...
    <div class="col-xs-12">
      ...
      <!--  <div class="row">
        <div class="col-sm-5" style="padding-top: 0.5em;margin-left: 0.5em;">
             <form action="{{ route('admin.societies.filterReports', $society->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
              @csrf
                  <div class="row">
                    <div class="col-sm-12">
...
$(document).ready(function(){
  ...
  var doctordatatable = $('#societies_datatable').DataTable({
      responsive: true,
      "processing": true,
      "ajax": "{{ route('admin.societies.reports', $society->id) }}",
      "language": {
